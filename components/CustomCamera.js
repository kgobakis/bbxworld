...
class CustomCamera extends Component {
    ...
    render() {
        ...
        if (hasCameraPermission === null) {
            ...
            return (
                <View style={{flex: 1}}>
                    <Camera ratio={'16:9'} style={{flex: 1, justifyContent: 'space-between'}} type={this.state.type}>
                        ...
                        <View style={{
                            ...
                            <View style={{alignItems: 'center'}}>
                                ...
                                ></MaterialCommunityIcons>
                                <Ionicons name="ios-images" style={{color: 'white', fontSize: 36}}/>
                            </View>
                            <TouchableOpacity onPress={() => {
                                ...
                                <Ionicons name="ios-reverse-camera" style={{color: 'white', fontSize: 36}}/>
                            </TouchableOpacity>
